...
def choosing_a_player():
    global choosePlayer, prologOn1, prologOn2, bot, player, setting
    while choosePlayer:
        screen.fill((0, 0, 0))
        ...
        text4 = font.render(f'[I] Settings', False, BLUE)
...
def game():
    ...
    while gameOn:
        ...
        if player:
            sec_player = 'PLAYER_2'
        text_surface = my_font.render(f'PONG SCORE [PLAYER_1 : {sec_player}] [{score[0]} : {score[1]}]', False, WHITE)
